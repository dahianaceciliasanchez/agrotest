...
import static agro.PedidosCompra.txtDescripcion;
import static agro.PedidosCompra.txtStock;
import static agro.PedidosCompra.txtdetalle;
import static agro.PedidosCompra.txtidproductos;
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
                txtidproductos.setText(conn.resultado.getString("id"));
