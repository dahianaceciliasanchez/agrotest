...
import static agro.PresupuestoProveedor.txtDescripcion;
import static agro.PresupuestoProveedor.txtidproducto;
 ...
 */
public class BuscarProductopre extends javax.swing.JFrame {

    Conexion conn = new Conexion();
    javax.swing.table.DefaultTableModel m;

    public BuscarProductopre() {
        initComponents();
    ...
    private void cargaTabla() {
        m.setRowCount(0);
        String sql = "SELECT id, Descripcion, Detalle FROM productos";
        ...
        try {
            ...
            Logger.getLogger(BuscarProductopre.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
                txtidproducto.setText(conn.resultado.getString("id"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarProductopre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarProductopre().setVisible(true);
            }
        });
    }
