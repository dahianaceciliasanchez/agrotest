...
import static agro.OrdenCompra.txtApellido;
import static agro.OrdenCompra.txtCI;
import static agro.OrdenCompra.txtCorreo;
import static agro.OrdenCompra.txtNombreE;
import static agro.OrdenCompra.txtidempleado;
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
                ...
                txtNombreE.setText(conn.resultado.getString("Nombre"));
