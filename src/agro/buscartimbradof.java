 ...
 */
public class buscartimbradof extends javax.swing.JFrame {

    Conexion conn = new Conexion();
    javax.swing.table.DefaultTableModel m;

    public buscartimbradof() {
        initComponents();
    ...
    private void cargaTabla() {
        ...
        String sql = "select t.id, t.Descripcion, t.FechaI, t.FechaF, t.proveedorid, "
                + "p.Nombre Nombre_Proveedor,t.estado \n"
                + "from timbrado t\n"
        ...
        try {
            ...
            while (conn.resultado.next()) {
                m.addRow(new Object[]{conn.resultado.getInt("id"),
                    conn.resultado.getString("Descripcion"), conn.resultado.getString("FechaI"),
                    conn.resultado.getString("FechaF"),
                    conn.resultado.getString("proveedorid"),
                    conn.resultado.getString("Nombre_Proveedor"),
                 conn.resultado.getString("estado")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(buscartimbradof.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Num_Timbrado", "FechaVigencia", "FechaVencimeinto", "Cod_Proveedor", "Nombre_Proveedor"
            }
        ));
        ...
        if (Lista.getColumnModel().getColumnCount() > 0) {
            ...
            Lista.getColumnModel().getColumn(4).setPreferredWidth(2);
        }
    ...
    private void BuscarSementales() {
        String sql = "select * from timbrado where id = " + Lista.getValueAt(Lista.getSelectedRow(), 0).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscartimbradof.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscartimbradof().setVisible(true);
            }
        });
    }
