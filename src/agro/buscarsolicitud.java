 ...
 */
package agro;
import static agro.RegistroIA.txtSolicitud;
import static agro.RegistroIA.txtids;
 ...
 */
public class buscarsolicitud extends javax.swing.JFrame {
    ...
    private void cargaTabla() {
        ...
        try {
            ...
            Logger.getLogger(buscarsolicitud.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Fecha de Solicitud", "Nro de Solciitud", "Empleado"
            }
        ) {
...
//    
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
                ...
                txtSolicitud.setText(conn.resultado.getString("NroSolicitud"));
                txtids.setText(conn.resultado.getString("id"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarsolicitud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarsolicitud().setVisible(true);
            }
        });
    }
