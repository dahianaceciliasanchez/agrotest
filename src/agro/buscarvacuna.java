...
import static agro.PlanificacionIA.txtFechavencimiento;
import static agro.PlanificacionIA.txtNombre;
import static agro.PlanificacionIA.txtStock;
 ...
 */
public class buscarvacuna extends javax.swing.JFrame {
Conexion conn = new Conexion ();
        ...
        initComponents();
         ...
         cargaTabla();
          ...
          private void cargaTabla() {
           m.setRowCount(0);
        String sql = "SELECT id, Nombre, FechaV, Stock  FROM vacunas";
        String columna = "id";
            ...
            while(conn.resultado.next()){
                m.addRow(new Object[] {conn.resultado.getInt("id"),
                   conn.resultado.getString("Nombre"),
                    conn.resultado.getString("FechaV"),
                    conn.resultado.getString("Stock")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(buscarvacuna.class.getName()).log(Level.SEVERE, null, ex);
        }
 }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarvacuna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarvacuna().setVisible(true);
            }
        });
    }
