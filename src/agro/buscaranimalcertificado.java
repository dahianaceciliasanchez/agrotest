...
import static agro.TarjetadeVacunacion.txtHBP;
import static agro.TarjetadeVacunacion.txtRP;
import static agro.TarjetadeVacunacion.txtnombre;
import java.sql.SQLException;
import java.util.logging.Level;
import java.util.logging.Logger;
import static agro.TarjetadeVacunacion.idanimal;


public class buscaranimalcertificado extends javax.swing.JFrame {
Conexion conn = new Conexion ();
     ...
     */
    public buscaranimalcertificado() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(buscaranimalcertificado.class.getName()).log(Level.SEVERE, null, ex);
        }
 }
    ...
    private void BuscarSementales() {
        ...
        try {
            if(conn.resultado.next()){
                idanimal.setText(conn.resultado.getString("id"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscaranimalcertificado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscaranimalcertificado().setVisible(true);
            }
        });
    }
