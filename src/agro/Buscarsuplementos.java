 ...
 */
public class Buscarsuplementos extends javax.swing.JFrame {
Conexion conn = new Conexion ();
    javax.swing.table.DefaultTableModel  m;

    public Buscarsuplementos() {
        initComponents();
         ...
         cargaTabla();
          ...
          private void cargaTabla() {
           m.setRowCount(0);
        String sql = "SELECT id, Descripcion, Stock, IVA FROM productos";
        String columna = "id";
        ...
        try {
            ...
            Logger.getLogger(Buscarsuplementos.class.getName()).log(Level.SEVERE, null, ex);
        }
 }
    ...
    private void BuscarSementales() {
        ...
        try {
            if(conn.resultado.next()){
                Suplementos.idproducto.setText(conn.resultado.getString("id"));
                Suplementos.txtnombre.setText(conn.resultado.getString("Descripcion"));
                txtstock.setText(conn.resultado.getString("Stock"));
                Suplementos.txtdetalle.setText(conn.resultado.getString("Detalle"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscarsuplementos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buscarsuplementos().setVisible(true);
            }
        });
    }
