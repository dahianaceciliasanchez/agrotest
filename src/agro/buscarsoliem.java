...
import static agro.PLandeEngorde.txtNro;
import static agro.PLandeEngorde.txtidempleado;
import static agro.PLandeEngorde.txtnombreapellido;
...
public class buscarsoliem extends javax.swing.JFrame {
    ...
    private void cargaTabla() {
        m.setRowCount(0);
        String sql = "SELECT t.id, t.Nrosolicitud, t.empleadoid, e.Nombre\n"
                + "FROM solicitudtrabajo AS t\n"
                + "INNER JOIN empleados AS e\n"
                + "ON t.empleadoid = e.id";
        String columna = "id";
        ...
        try {
            ...
            while (conn.resultado.next()) {
                m.addRow(new Object[]{conn.resultado.getInt("id"),
                    conn.resultado.getString("NroSolicitud"),
                    conn.resultado.getString("empleadoid"),
                conn.resultado.getString("Nombre")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(buscarsoliem.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nro Solicitud", "Cod_Empleado", "Nombre"
            }
        ) {
    ...
    private void BuscarSementales() {
        String sql = "select * from solicitudtrabajo where id = " + Lista.getValueAt(Lista.getSelectedRow(), 0).toString();
        System.out.println(sql);
        conn.traeDatos(sql);
        try {
            if (conn.resultado.next()) {
                txtidempleado.setText(conn.resultado.getString("id"));
                txtNro.setText(conn.resultado.getString("NroSolicitud"));
                txtnombreapellido.setText(conn.resultado.getString("empleadoid"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarsoliem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarsoliem().setVisible(true);
            }
        });
    }
