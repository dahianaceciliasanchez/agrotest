...
public class Buscarpresupuestopro extends javax.swing.JFrame {
    ...
    private void cargaTabla() {
        ...
        try {
            ...
            Logger.getLogger(Buscarpresupuestopro.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "FechaPresupuesto", "id_Proveedor", "Nombre_Proveedor", "Nro_Presupuesto"
            }
        ));
...
//                txtgmail.setText(conn.resultado.getString("Gmail"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscarpresupuestopro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buscarpresupuestopro().setVisible(true);
            }
        });
    }
