...
import static agro.TarjetadeVacunacion.txtvacunador;
import java.sql.SQLException;
import java.util.logging.Level;
import java.util.logging.Logger;
import static agro.TarjetadeVacunacion.txtidempleado;
...
public class Buscarempleadot extends javax.swing.JFrame {

    Conexion conn = new Conexion();
    javax.swing.table.DefaultTableModel m;

    public Buscarempleadot() {
        initComponents();
    ...
    private void cargaTabla() {
        ...
        try {
            ...
            Logger.getLogger(Buscarempleadot.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre", "Apellido", "CI", "Correo E", "Telefono"
            }
        ));
    ...
    private void BuscarSementales() {
        ...
        try {
            if (conn.resultado.next()) {
               ...
               txtvacunador.setText(conn.resultado.getString("Nombre"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscarempleadot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buscarempleadot().setVisible(true);
            }
        });
    }
