...
public class PlanVacunacion extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String sql = "Insert into planificacionvacunacion (etapasid, FechaDosis, vacunasid, animalid, cantidadDosis) "
                + "values(" + etapas + ",DATE(NOW())," + txtidvacuna.getText() + "," + txtidanimal.getText() + " , "
                + "" + txtCantidad.getText() + ")";
