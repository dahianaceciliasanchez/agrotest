...
import static agro.PlanificacionIA.peso;
import static agro.PlanificacionIA.txtFechaN;
import static agro.PlanificacionIA.txtHBP;
import static agro.PlanificacionIA.txtNombre;
import static agro.PlanificacionIA.txtPelaje;
import static agro.PlanificacionIA.txtRP;
import static agro.PlanificacionIA.txtidanimal;
 ...
 */
public class buscarani extends javax.swing.JFrame {
        ...
        try {
            ...
            while (conn.resultado.next()) {
                m.addRow(new Object[]{conn.resultado.getInt("id"),
                    ...
                    conn.resultado.getString("Pelaje")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(buscarani.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarani.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
