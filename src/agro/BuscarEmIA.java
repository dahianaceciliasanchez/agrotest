 ...
 */
public class BuscarEmIA extends javax.swing.JFrame {
    ...
    private void cargaTabla() {
        ...
        try {
            ...
            Logger.getLogger(BuscarEmIA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarEmIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarEmIA().setVisible(true);
            }
        });
    }
