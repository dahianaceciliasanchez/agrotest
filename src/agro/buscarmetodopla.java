...
import static agro.ProtocolosIA.txtid;
import static agro.ProtocolosIA.txtidhembra;
import static agro.ProtocolosIA.txtmetodo;
 ...
 */
public class buscarmetodopla extends javax.swing.JFrame {

    Conexion conn = new Conexion();
    javax.swing.table.DefaultTableModel m;

    public buscarmetodopla() {
        initComponents();
    ...
    private void cargaTabla() {
        m.setRowCount(0);
        String sql = "SELECT id, Animalid, MetodoIA FROM planificacionia";
        String columna = "id";
        ...
        try {
            ...
            while (conn.resultado.next()) {
                m.addRow(new Object[]{conn.resultado.getString("id"), conn.resultado.getString("Animalid"),
                    conn.resultado.getString("MetodoIA")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(buscarmetodopla.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Planificacion IA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), java.awt.Color.gray)); // NOI18N
    ...
    private void BuscarSementales() {
        String sql = "select * from planificacionia where id = " + Lista.getValueAt(Lista.getSelectedRow(), 0).toString();
        ...
        try {
            if (conn.resultado.next()) {
                ...
                txtmetodo.setText(conn.resultado.getString("MetodoIA"));
                dispose();
            }
        } catch (SQLException ex) {
            Logger.getLogger(buscarmetodopla.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarmetodopla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarmetodopla().setVisible(true);
            }
        });
    }
