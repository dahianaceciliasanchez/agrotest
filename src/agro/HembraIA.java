 ...
 */
public class HembraIA extends javax.swing.JFrame {
Conexion conn = new Conexion ();
    ...
    public HembraIA() {
        initComponents();
         ...
         cargaTabla();
          ...
          private void cargaTabla() {
           m.setRowCount(0);
        String sql =    "Select id,  Nombre, RP , HBP, Pelaje FROM Animal order by nombre";
        String columna = "RP";
        ...
        try {
            ...
            Logger.getLogger(HembraIA.class.getName()).log(Level.SEVERE, null, ex);
        }
 }
...
//    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HembraIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
