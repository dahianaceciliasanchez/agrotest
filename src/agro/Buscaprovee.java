 ...
 */
public class Buscaprovee extends javax.swing.JFrame {
    ...
    private void cargaTabla() {
        m.setRowCount(0);
        String sql = "Select t.id, t.Descripcion, t.FechaI, t.FechaF, t.proveedorid, p.Nombre, p.RUC, p.Telefono \n"
                + "from timbrado t \n"
        ...
        try {
            ...
            Logger.getLogger(Buscaprovee.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Descripcion", "FechaI", "FechaF", "Cod_Proveedor", "Nombre_Proveedor", "RUC_Proveedor", "Telefono_Proveedor"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscaprovee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buscaprovee().setVisible(true);
            }
        });
    }
