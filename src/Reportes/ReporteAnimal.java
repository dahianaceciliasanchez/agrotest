...
import agro.*;
import buscadores.buscarcatego;
import buscadores.buscarrazare;
...
public class ReporteAnimal extends javax.swing.JFrame {
    ...
    private void txtidcategoriaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtidcategoriaMousePressed
         buscarcatego objeto = new buscarcatego();
    ...
    private void txtidrazaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtidrazaMousePressed
        ...
        buscarrazare objeto = new buscarrazare();
        objeto.setLocationRelativeTo(null);
        objeto.setVisible(true);
    ...
    public static javax.swing.JTextField txtidraza;
