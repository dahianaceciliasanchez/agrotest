 ...
 */
public class reporteajustestocksemen extends javax.swing.JFrame {
Conexion conn = new Conexion ();
    javax.swing.table.DefaultTableModel  m;

    public reporteajustestocksemen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Semental");

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("REPORTE AJUSTE DE STOCK DE SEMEN");

        jLabel2.setText("Motivo Ajuste");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reporteajustestocksemen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reporteajustestocksemen().setVisible(true);
            }
        });
    }
