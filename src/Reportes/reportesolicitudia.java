 ...
 */
public class reportesolicitudia extends javax.swing.JFrame {
Conexion conn = new Conexion ();
    javax.swing.table.DefaultTableModel  m;

    public reportesolicitudia() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPORTE SOLICITUD IA");

        jLabel2.setText("Nro Solciitud");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reportesolicitudia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reportesolicitudia().setVisible(true);
            }
        });
    }
