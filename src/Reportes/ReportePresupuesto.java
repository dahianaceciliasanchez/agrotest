...
import agro.*;
import buscadores.buscarproveedor;
...
public class ReportePresupuesto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRESUPUESTO PROVEEDOR");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtnro, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        parametro.put("p_proveedor", txtidpro.getText());
        
        try {
            String fileName = "src\\Reportes\\presupuestoreporte.jasper";
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
       Map parametro = new HashMap();
        parametro.put("p_nropre", txtnro.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportePresupuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportePresupuesto().setVisible(true);
            }
        });
    }
