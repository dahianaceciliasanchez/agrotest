...
import static Reportes.ReporteSolcitiudT.txtidem;
import static Reportes.ReporteSolcitiudT.txtnombreempleado;
import agro.*;
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
               ...
               txtnombreempleado.setText(conn.resultado.getString("Nombre"));
