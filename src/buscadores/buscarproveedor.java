...
import static Reportes.ReportePresupuesto.txtidpro;
import static Reportes.ReportePresupuesto.txtproveedor;
import agro.*;
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
                ...
                txtproveedor.setText(conn.resultado.getString("nombre"));
