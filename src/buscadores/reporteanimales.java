...
import static Reportes.ReporteEngorde.ttxnombre;
import static Reportes.ReporteEngorde.txtidanimal;
import agro.*;
...
Conexion conn = new Conexion ();
    ...
    public reporteanimales() {
        ...
        try {
            ...
            Logger.getLogger(reporteanimales.class.getName()).log(Level.SEVERE, null, ex);
        }
 }
    ...
    private void BuscarSementales() {
        ...
        try {
            if(conn.resultado.next()){
                ...
                ttxnombre.setText(conn.resultado.getString("Nombre"));
