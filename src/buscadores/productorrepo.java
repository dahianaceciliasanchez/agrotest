...
import static Reportes.SuplementosReporte.txtidpro;
import static Reportes.SuplementosReporte.txtproducto;
import agro.*;
 ...
 */
public class productorrepo extends javax.swing.JFrame {

    Conexion conn = new Conexion();
    javax.swing.table.DefaultTableModel m;

    public productorrepo() {
        initComponents();
    ...
    private void cargaTabla() {
        ...
        try {
            ...
            Logger.getLogger(productorrepo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
                txtidpro.setText(conn.resultado.getString("id"));
                txtproducto.setText(conn.resultado.getString("Descripcion"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(productorrepo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new productorrepo().setVisible(true);
            }
        });
    }
