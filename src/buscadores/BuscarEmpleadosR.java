...
import static Reportes.ReporteEngorde.idempleado;
import static Reportes.ReporteEngorde.txtempleado;
import agro.*;
 ...
 */
public class BuscarEmpleadosR extends javax.swing.JFrame {

    Conexion conn = new Conexion();
    javax.swing.table.DefaultTableModel m;

    public BuscarEmpleadosR() {
        initComponents();
    ...
    private void cargaTabla() {
        m.setRowCount(0);
        String sql = "SELECT id, Nombre, apellido, CI, Gmail FROM empleados";
        ...
        try {
            ...
            Logger.getLogger(BuscarEmpleadosR.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre", "Apellido", "CI", "Direccion", "Correo"
            }
        ));
    ...
    private void Buscar() {
        ...
        try {
            if (conn.resultado.next()) {
                ...
                txtempleado.setText(conn.resultado.getString("Nombre"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarEmpleadosR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarEmpleadosR().setVisible(true);
            }
        });
    }
