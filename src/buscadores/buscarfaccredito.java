...
import static agro.NotaCreditoD.txtidfac;
import static agro.NotaCreditoD.txtnombrepc;
import static agro.NotaCreditoD.txtprecioc;
import static agro.NotaCreditoD.txtproductoidc;
...
public class buscarfaccredito extends javax.swing.JFrame {

    Conexion conn = new Conexion();
    javax.swing.table.DefaultTableModel m;

    public buscarfaccredito() {
        initComponents();
    ...
    private void cargaTabla() {
        m.setRowCount(0);
        String sql = "select d.id detalle_fac, d.facturaid, f.fechaemision, f.nrofactura, d.productosid, p.Descripcion, d.precio, d.cantidad \n"
        ...
        try {
            ...
            while (conn.resultado.next()) {
                m.addRow(new Object[]{conn.resultado.getInt("detalle_fac"),
                    ...
                    conn.resultado.getString("precio"),
                    conn.resultado.getString("cantidad")});
            }
        } catch (SQLException ex) {
            Logger.getLogger(buscarfaccredito.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        Lista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD_DETALLE_FACT", "COD_FACTURAID", "FECHA EMISION", "NRO_FACTURA", "COD_PRODUCTOS", "DESCRIPCION", "PRECIO", "CANTIDAD"
            }
        ) {
    ...
    private void BuscarSementales() {
        String sql = "select d.id detalle_fac, f.nrofactura,"
                + " d.productosid, p.Descripcion, d.precio, d.cantidad \n"
                + "from detallefactura d \n"
                + "inner join facturaproveedor f \n"
                + "on d.facturaid = f.id \n"
                + "inner join productos p \n"
        ...
        try {
            if (conn.resultado.next()) {
                txtidfac.setText(conn.resultado.getString("detalle_fac"));
                txtfactura.setText(conn.resultado.getString("nrofactura"));
                txtproductoidc.setText(conn.resultado.getString("productosid"));
                txtnombrepc.setText(conn.resultado.getString("descripcion"));
                txtprecioc.setText(conn.resultado.getString("precio"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarfaccredito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarfaccredito().setVisible(true);
            }
        });
    }
